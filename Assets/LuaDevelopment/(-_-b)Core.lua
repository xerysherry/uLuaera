...
function Color(r, g, b, a)
    if type(r) == "string" then
        ...
        elseif name == "white" then
            return UnityEngine.Color.GetWhite()
        elseif name == "black" then
            return UnityEngine.Color.GetBlack()
        elseif name == "blue" then
            return UnityEngine.Color.GetBlue()
        elseif name == "clear" then
            return UnityEngine.Color.GetClear()
        elseif name == "cyan" then
            return UnityEngine.Color.GetCyan()
        elseif name == "gray" or name == "grey" then
            return UnityEngine.Color.GetGray()
        elseif name == "green" then
            return UnityEngine.Color.GetGreen()
        elseif name == "magenta" then
            return UnityEngine.Color.GetMagenta()
        elseif name == "red" then
            return UnityEngine.Color.GetRed()
        elseif name == "yellow" then
            return UnityEngine.Color.GetYellow()
        else
            r = 1
            g = 1
            b = 1
...
GetDisplayLength = function(s, fontsize, richedit)
    ...
    StringHelper.GetDisplayLength(s, fontsize, richedit)
end
GetStringBar = StringHelper.GetStringBar
Space = StringHelper.Space
...
SetDefaultFlags = function(v)
    if type(v) == "table" then
        Config.set_FlagBit(v)
    else
        Config.SetFlags(v)
    end
end
GetDefaultFlags = Config.GetFlags
GetFlagBit = Config.get_FlagBit
SetDefaultColor = function(r, g, b, a)
    if type(r) == "table" then
        Config.set_FontColor(r)
    else
        Config.set_FontColor(Color(r, g, b, a))
    end
end
GetDefaultColor = Config.get_FontColor
SetDefaultGradientColor = function(r, g, b, a)
    if type(r) == "table" then
        Config.set_FontGradientColor(r)
    else
        Config.set_FontGradientColor(Color(r, g, b, a))
    end
end
GetDefaultGradientColor = Config.get_FontGradientColor
SetDefaultShadowColor = function(r, g, b, a)
    if type(r) == "table" then
        Config.set_FontShadowColor(r)
    else
        Config.set_FontShadowColor(Color(r, g, b, a))
    end
end
GetDefaultShadowColor = Config.get_FontShadowColor
SetDefaultOutlineColor = function(r, g, b, a)
    if type(r) == "table" then
        Config.set_FontOutlineColor(r)
    else
        Config.set_FontOutlineColor(Color(r, g, b, a))
    end
end
GetDefaultOutlineColor = Config.get_FontOutlineColor
SetDefaultSize = Config.set_FontSize
GetDefaultSize = Config.get_FontSize
SetDefaultImageColor = function(r, g, b, a)
    if type(r) == "table" then
        Config.set_ImageColor(r)
    else
        Config.set_ImageColor(Color(r, g, b, a))
    end
end
GetDefaultImageColor = Config.get_ImageColor
...
GetResourcePath = Config.get_ResourcePath
GetSavePath = Config.GetSavePath
SetSavePath = Config.SetSavePath
GetCsvPath = Config.GetCsvPath
SetCsvPath = Config.SetCsvPath

SetMaxLineCount = Config.set_MaxLog
GetMaxLineCount = Config.get_MaxLog
SetDefaultLineHeight = Config.set_LineHeight
GetDefaultLineHeight = Config.get_LineHeight
...
SetConsoleBorder = function(left_or_table, top, right, bottom)
    if type(left_or_table) == "table" then
        ...
        Printer.SetConsoleBorder(left_or_table or 0, 
                                top or 0,
                                right or 0, 
                                bottom or 0)
    end
...
Date = function(year, month, day, hour, min, sec)
    return Printer.Date(year, month, day, hour, min, sec)
end
...
SetColor = function(r, g, b, a) 
    if type(r) == "table" then
        ...
        Printer.set_color(Color(r, g, b, a))
    end
end
GetColor = Printer.get_color
...
SetGradientColor = function(r, g, b, a) 
    if type(r) == "table" then
        Printer.set_gradient_color(r)
    else
        Printer.set_gradient_color(Color(r, g, b, a))
    end
end
GetGradientColor = Printer.get_gradient_color
...
SetShadowColor = function(r, g, b, a) 
    if type(r) == "table" then
        Printer.set_shadow_color(r)
    else
        Printer.set_shadow_color(Color(r, g, b, a))
    end
end
GetShadowColor = Printer.get_shadow_color
...
SetOutlineColor = function(r, g, b, a)
    if type(r) == "table" then
        Printer.set_outline_color(r)
    else
        Printer.set_outline_color(Color(r, g, b, a))
    end
end
GetOutlineColor = Printer.get_outline_color
...
SetImageColor = function(r, g, b, a) 
    if type(r) == "table" then
        Printer.set_image_color(r)
    else
        Printer.set_image_color(Color(r, g, b, a))
    end
end
GetImageColor = Printer.get_image_color
...
SetAutoLine = function(line_count)
    ...
    Printer.SetAutoLine(line_count)
end
